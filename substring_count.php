...
// this will count "obvious" and "obviously".  Does not care about the characters that come before or after the string it is searching for. 
...
//substr_count():
//returns the number of instances of a substring within a string 
